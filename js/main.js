...
(function initPropertyImagesAndGallery(){
  ...
  const defaults=[
    ...
    {src:'assets/images/galeria/galeria-02.png',alt:'Ganado Nelore',title:'Ganado Nelore — Más de 300 Cabezas'},
    {src:'assets/images/galeria/galeria-03.png',alt:'Vista aérea',title:'Vista Aérea — Más de 500 Hectáreas'},
...
const LANGS = {
  es:{
    ...
    'hero.eyebrow':'IMPULSANDO LA GANADERÍA EN MADRE DE DIOS, PERÚ',
    'hero.cta1':'Agenda tu cita','hero.cta2':'Más información',
    'fi.ha':'hectáreas totales','fi.cab':'cabezas Nelore incluidas','fi.past':'ha de pasturas','fi.llave':'llave en mano',
  ...
  pt:{
    ...
    'hero.eyebrow':'IMPULSIONANDO A PECUÁRIA EM MADRE DE DIOS, PERU',
    'hero.cta1':'Agende sua visita','hero.cta2':'Mais informações',
    'fi.ha':'hectares totais','fi.cab':'cabeças Nelore incluídas','fi.past':'ha de pastagens','fi.llave':'chave na mão',
  ...
  en:{
    ...
    'hero.eyebrow':'BOOSTING CATTLE RANCHING IN MADRE DE DIOS, PERU',
    'hero.cta1':'Schedule your visit','hero.cta2':'More information',
    'fi.ha':'total hectares','fi.cab':'Nelore head included','fi.past':'ha of pastures','fi.llave':'turnkey',
...
(function(){
  ...
  form.addEventListener('submit',e=>{
    ...
    lines.push('', 'Propiedad: Más de 500 ha · Más de 300 cabezas Nelore · a 15 min de Puerto Maldonado · Madre de Dios');
