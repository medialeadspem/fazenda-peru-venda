...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  propM.bindPopup(popup('🏡 Hacienda Madre de Dios','Más de 500 ha · Más de 300 cabezas Nelore','#FFD100','rgba(255,209,0,.1)'));
  ...
  L.marker(AIRPORT,{icon:airIco}).addTo(map)
    .bindPopup(popup('✈️ Puerto Maldonado','A 15 minutos de la propiedad','rgba(255,255,255,.8)','rgba(255,255,255,.05)'));
